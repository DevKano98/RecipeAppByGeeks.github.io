...
// Function to fetch Seafood recipes automatically when the page loads
const fetchSeafoodRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Seafood Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Seafood recipes were found...</h2>";
  }
};
...
// Fetch Seafood recipes when the page loads
window.onload = fetchSeafoodRecipes;
