...
// Function to fetch beef recipes automatically when the page loads
const fetchBeefRecipes = async () => {
    recipeContainer.innerHTML = "<h2>Fetching Beef Recipes...</h2>";
    try {
        ...
        recipeContainer.innerHTML = "<h2>Sorry, but no Beef recipes were found...</h2>";
    }
}
...
// Fetch beef recipes when the page loads
window.onload = fetchBeefRecipes;
