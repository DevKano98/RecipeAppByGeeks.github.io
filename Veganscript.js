...
// Function to fetch Vegan recipes automatically when the page loads
const fetchVeganRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Vegan Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Vegan recipes were found...</h2>";
  }
};
...
// Fetch Vegan recipes when the page loads
window.onload = fetchVeganRecipes;
