...
// Function to fetch Pasta recipes automatically when the page loads
const fetchPastaRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Pasta Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Pasta recipes were found...</h2>";
  }
};
...
// Fetch Pasta recipes when the page loads
window.onload = fetchPastaRecipes;
