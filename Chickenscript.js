...
// Function to fetch Chicken recipes automatically when the page loads
const fetchChickenRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Chicken Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Chicken recipes were found...</h2>";
  }
};
...
// Fetch Chicken recipes when the page loads
window.onload = fetchChickenRecipes;
