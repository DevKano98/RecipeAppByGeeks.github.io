...
// Function to fetch Lamb recipes automatically when the page loads
const fetchLambRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Lamb Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Lamb recipes were found...</h2>";
  }
};
...
// Fetch Lamb recipes when the page loads
window.onload = fetchLambRecipes;
