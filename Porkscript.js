...
// Function to fetch Pork recipes automatically when the page loads
const fetchPorkRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Pork Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Pork recipes were found...</h2>";
  }
};
...
// Fetch Pork recipes when the page loads
window.onload = fetchPorkRecipes;
