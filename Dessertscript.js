...
// Function to fetch Dessert recipes automatically when the page loads
const fetchDessertRecipes = async () => {
  recipeContainer.innerHTML = "<h2>Fetching Dessert Recipes...</h2>";
  try {
    ...
    recipeContainer.innerHTML =
      "<h2>Sorry, but no Dessert recipes were found...</h2>";
  }
};
...
// Fetch Dessert recipes when the page loads
window.onload = fetchDessertRecipes;
